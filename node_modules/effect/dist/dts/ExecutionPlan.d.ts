...
export declare namespace make {
     ...
     * @experimental
     */
    type StepProvides<S extends Step> = S["provide"] extends Context.Context<infer P> | Layer.Layer<infer P, infer _E, infer _R> ? P : never;
    /**
     * @since 3.16.0
     * @experimental
     */
     ...
     * @experimental
     */
    type PlanInput<Plans extends ReadonlyArray<any>, Out = unknown> = Plans extends readonly [infer Plan, ...infer Rest] ? PlanInput<Rest, Out & (Plan extends ExecutionPlan<infer T> ? T["input"] : never)> : Out;
    /**
     * @since 3.16.0
     * @experimental
     */
    type StepError<S extends Step> = (S["provide"] extends Context.Context<infer _P> | Layer.Layer<infer _P, infer E, infer _R> ? E : never) | (S["while"] extends (input: infer _I) => Effect.Effect<infer _A, infer _E, infer _R> ? _E : never);
    /**
     * @since 3.16.0
     * @experimental
     */
    type StepRequirements<S extends Step> = (S["provide"] extends Layer.Layer<infer _A, infer _E, infer R> ? R : never) | (S["while"] extends (input: infer _I) => Effect.Effect<infer _A, infer _E, infer R> ? R : never) | (S["schedule"] extends Schedule.Schedule<infer _O, infer _I, infer R> ? R : never);
}
/**
 * @since 3.16.0
 * @category Combining
